...
public class PositiveStartingBalance extends Exception
{
   /**
      This constructor uses a generic
      error message.
   */
   ...
   public PositiveStartingBalance()
   {
      super("Yay!: Positive starting balance");
   }
   ...
   */
   ...
   public PositiveStartingBalance(double amount)
   {
      super("Wheee!: Positive starting balance: " +
            amount);
   }
}