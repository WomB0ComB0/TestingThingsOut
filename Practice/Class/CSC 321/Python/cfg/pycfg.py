...
class pyCFG(tkinter.Tk):
    def __init__(self):
        ...
        tkinter.Label(self, text="Variables (V):").grid(
        ...
        tkinter.Label(self, text="Terminals (Σ):").grid(
        ...
        tkinter.Label(self, text="Start variable (S): ").grid(
        ...
        tkinter.Label(self, text="Null character : ").grid(
            row=3, column=2, sticky=tkinter.W
        )
        ...
        tkinter.Button(
            evaluate_button_frame, text="Evaluate", command=self._evaluate
        ).grid(sticky=tkinter.NSEW, padx=1, pady=1)
        ...
        tkinter.Label(self.string_frame, text="String : ").grid(
        ...
        tkinter.Button(
            self.string_frame, text="Check", command=self._check_string
        ).grid(row=0, column=2)
    ...
    def _check_string(self):
        if self.cfg[4].cyk(self.string_entry.get()):
            ...
            messagebox.showerror(
                "CYK algorithm", "Grammar cannot generate entered string"
            )
    ...
    def _evaluate(self):
        ...
        try:
            ...
            _cfg = CFG(
                ...
                terminals,
                rules,
                self.start_variable_entry.get(),
                self.null_character_entry.get(),
            )
    ...
    def _load_from_file(self):
        ...
        try:
            with open(file_name) as file:
                ...
                if len(lines) < 4:
                    messagebox.showerror(
                        "Error in input file", "Input file content is not correct."
                    )
                    return
    ...
    def _show_about(self):
        ...
        tkinter.Label(
            self.about_window, text="pyCFG", font="TkDefaultFont 15 bold"
        ).pack(pady=(15, 10))
        tkinter.Label(self.about_window, text="1.0.0", font="TkDefaultFont 10").pack()
        tkinter.Label(
            self.about_window, text="Github repository:", font="TkDefaultFont 10"
        ).pack(pady=(15, 0))
        github_link = tkinter.Label(
            self.about_window,
            text="http://github.com/mahdavipanah/pyCFG",
        ...
        github_link.bind(
            "<Button-1>",
            lambda x: webbrowser.open("http://github.com/mahdavipanah/pyCFG"),
        )
        tkinter.Label(
            self.about_window, text="Created by:", font="TkDefaultFont 10"
        ).pack()
        tkinter.Label(
            self.about_window, text="Hamidreza Mahdavipanah", font="TkDefaultFont 10"
        ).pack()
        tkinter.Label(
            self.about_window, text="Licensed under MIT license", font="TkDefaultFont 8"
        ).pack(pady=(20, 0))
