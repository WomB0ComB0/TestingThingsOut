 ...
 * The largest key on the left child is called its in-order predecessor.
 * 
 * In-order Successor
 ...
 * 3. A node should have a minimum of ceil(m/2) children. (i.e. 2)
 * 4. A node (except root node) should contain a minimum of ceil(m/2) - 1 keys. (i.e. 1)
*/
...
public class BTreeDeletion {
  ...
  public static void main(String[] args) {
    BTreeDeletion b = new BTreeDeletion(3);
    b.Insert(8);
    b.Insert(9);
    b.Insert(10);
    b.Insert(11);
