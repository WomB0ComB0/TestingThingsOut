 ...
 * 3. Add m/2th key to teh parent node as well.
 * 4. If the parent node is already full, follow steps 2 - 3.
*/

import java.util.*;

public class BPlusTreeInsertion {
    int m;
    InternalNode root;
    LeafNode firstLeaf;
    ...
    public BPlusTreeInsertion(int m) {
        this.m = m;
        this.root = null;
    }
    ...
    public static void main(String[] args) {
        BPlusTreeInsertion bpt = null;
        bpt = new BPlusTreeInsertion(3);
        bpt.insert(5, 33);
        bpt.insert(15, 21);
        bpt.insert(25, 31);
        bpt.insert(35, 41);
