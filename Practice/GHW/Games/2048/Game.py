...
class Game(tk.Frame):
    def __init__(self):
        ...
        # self.master.bind("<Left>", lambda event: self.left(event))
        # self.master.bind("<Right>", lambda event: self.right(event))
        # self.master.bind("<Up>", lambda event: self.up(event))
        # self.master.bind("<Down>", lambda event: self.down(event))
